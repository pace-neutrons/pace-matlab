...
ExternalProject_Add(@DL_ARGS_PROJ@-download
    ...
    DOWNLOAD_NO_EXTRACT "@DL_ARGS_DOWNLOAD_NO_EXTRACT@"
    CONFIGURE_COMMAND ""
    BUILD_COMMAND ""
    INSTALL_COMMAND ""
    TEST_COMMAND ""
...
set(var_template [=[
ExternalProject_Get_Property(@DL_ARGS_PROJ@-download DOWNLOADED_FILE)
...
function(download)
    ...
    if (DL_ARGS_DOWNLOAD_NO_EXTRACT)
        string(CONFIGURE "${var_template}" cmake_list2 @ONLY)
        string(APPEND cmake_lists ${cmake_list2})
    endif()
    ...
    if (DL_ARGS_DOWNLOAD_NO_EXTRACT)
        string(REGEX REPLACE ".*DOWNLOADED_FILE===" "" output ${output})
        string(REGEX REPLACE "==.*" "" output ${output})
        set(${DL_ARGS_PROJ}_DOWNLOADED_FILE ${output} PARENT_SCOPE)
    endif()
    if(result)
